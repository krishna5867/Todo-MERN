            ...
            <header className="bg-slate-700 text-white">
                <div className="flex flex-wrap p-5 flex-co sm:flex-row justify-between items-center  align-baseline py-3">
                    ...
                    <span className='flex sm:w-1/2'>
                        <input value={search} onChange={handleSearch} className="sm:max-w- bg-gay-200 appearance-none border-2 border-gray-200 rounded w-full py-1 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white" type="text" placeholder='Search' />
